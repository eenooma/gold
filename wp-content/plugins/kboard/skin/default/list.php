		...
		<table>
			<thead>
				<tr>
					...
					<?php if($board->id == '1'): ?><td class="kboard-list-uid"><?php echo __('Status', 'kboard')?></td><? endif?>
			...
			<tbody>
				...
				<tr class="<?php echo esc_attr($content->getClass())?>">
					...
					<?php if($board->id == '1'): ?><td class="kboard-list-status"><?php echo $content->option->{'status'}?></td><? endif?>
