<div id="kboard-document">
	<div id="kboard-default-document">
		<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
			...
			<?php if($content->option->{'phone'}):?>
				<div class="kboard-detail">
					<div class="detail-attr">
						<div class="detail-name">연락처</div>
						<div class="detail-value"><?php echo esc_html($content->option->{'phone'})?></div>
					</div>
				</div>
			<?php endif?>
			<?php if($content->option->{'bank'}):?>
				<div class="kboard-detail">
					<div class="detail-attr">
						<div class="detail-name">은행명</div>
						<div class="detail-value"><?php echo esc_html($content->option->{'bank'})?></div>
					</div>
				</div>
			<?php endif?>
			<?php if($content->option->{'account'}):?>
				<div class="kboard-detail">
					<div class="detail-attr">
						<div class="detail-name">계좌번호</div>
						<div class="detail-value"><?php echo esc_html($content->option->{'account'})?></div>
					</div>
				</div>
			<?php endif?>
			<?php if($content->option->{'account_holder'}):?>
				<div class="kboard-detail">
					<div class="detail-attr">
						<div class="detail-name">예금주</div>
						<div class="detail-value"><?php echo esc_html($content->option->{'account_holder'})?></div>
					</div>
				</div>
			<?php endif?>
			<?php if($content->option->{'status'}):?>
				<div class="kboard-detail">
					<div class="detail-attr">
						<div class="detail-name">접수상태</div>
						<div class="detail-value"><?php echo esc_html($content->option->{'status'})?></div>
					</div>
				</div>
			<?php endif?>
			<div class="kboard-detail">
